...
If the source JSON for the index contains multiple mapping types, you will create a separate index for each type rather than merging the types into a single typeless mapping.
